...
| Option | Description |
|--------|-------------|
| `-c, --columns {2,3,4}` | Number of time-scale columns (default: 2) |
...
The columns display cascading 10x time averages:
- **2 columns**: 25Hz live, 1s avg
- **3 columns**: 10s avg, 1s avg, 25Hz live
- **4 columns**: 100s avg, 10s avg, 1s avg, 25Hz live
